...
public class GraphicalUserInterface extends JFrame implements MessageDisplay {
	...
	private SummonActionListener summonActionListener;
	...
	public GraphicalUserInterface(Person player) {
		...
		JButton statusButton = new JButton("Pokemon around you");
		statusButton.addActionListener(new StatusButtonListener(this,player));
		controlPanel.add(statusButton);
		
		
		// Summon status Combo box
		summonJComboBox = new JComboBox();
		summonActionListener = new SummonActionListener(this,player,summonJComboBox);
		summonJComboBox.addActionListener(summonActionListener);
		controlPanel.add(summonJComboBox);
	...
	private void updateJComboBoxes() {
		...
		summonActionListener.updateJComboBox();
	...
	private void enableJComboListeners(boolean b) {
		...
		summonActionListener.setEnabled(b);
